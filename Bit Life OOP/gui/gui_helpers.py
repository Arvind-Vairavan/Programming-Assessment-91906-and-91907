...
def create_section(parent, title, content=None, buttons=None):
    ...
    Args:
        ...
        content (str or callable): Content text or function returning text
        buttons (list): List of button dicts with 'text' and 'action' keys
    """
...
def create_item_list(parent, items, action_func, label_format=None, 
    ...
    Args:
        ...
        button_text (str): Text on the action button
    """
    for item in items:
